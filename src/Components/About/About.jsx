        ...
        <div id="despre-noi" className={`${aboutCSS.about_wrapper} section`}>
            ...
            <div className = {aboutCSS.about_content}>
                ...
                {/* className={aboutCSS.aboutPensiune} */}
                    ...
                    <h3>Camerele de la această pensiune sunt echipate cu zonă de relaxare, televizor cu ecran plat cu canale prin cablu, bucătărie, zonă de luat masa și baie proprie cu articole de toaletă gratuite, duș și un uscător de păr. Pensiunea Adrian oferă anumite camere care includ un balcon, iar fiecare cameră include o cafetieră. La Pensiunea Adrian, fiecare cameră este dotată cu lenjerie de pat și prosoape. Această pensiune pune la dispoziție un teren de joacă pentru copii.
                    La Pensiunea Adrian puteți juca biliard, iar zona este populară pentru hiking și schi.</h3>
                </div>
